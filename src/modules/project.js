...
const renderProjectButton = (name, container) => {
  ...
  // Select Project
  projectItem
    .querySelector(".project__item--btn")
    .addEventListener("click", () => {
      document.dispatchEvent(
        new CustomEvent("filterProject", { detail: name }),
      );
    });

  // Delete Project
  projectItem
    .querySelector(".delete__proj--btn")
...
export const initProjects = () => {
  ...
  hideProjectBtn.addEventListener("click", () => {
    ...
    hideProjectBtn.style.transform = projectListContainer.classList.contains(
      "hidden",
    )
      ? "rotate(-90deg)"
      : "rotate(0deg)";
